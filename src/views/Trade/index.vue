  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="address in tradeList.userAddressList"
        :key="address.id"
      >
        <span
          :class="{ username: true, selected: address.id === selectedId }"
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="trade in tradeList.detailArrayList"
          :key="trade.skuId"
        >
          <li>
  ...
  computed: {
    selectAddress() {
      ...
      return userAddressList
        ? userAddressList.find((item) => item.id === selectedId)
        : {};
    },
  },
  async mounted() {
    const getTrade = await reqTradeList();
    this.tradeList = getTrade;
    this.selectedId = getTrade.userAddressList.find(
